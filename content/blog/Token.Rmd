...
> Essa linha de comando configura o seu token abrindo uma janela no navegador onde irá pedir a confirmação da sunha senha no GitHub, após executar esse comando devemos copiar o token gerado, para tal faz-se necessário estabelecer um prazo de validade para o token e algumas permissões adicionais.

-   Defina seu token no RStudio com o pacote credentials:

`credenciais :: set_github_pat(" seuTOKEN ")`
